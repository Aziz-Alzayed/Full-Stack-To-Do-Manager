...
namespace FSTD.Application.Tests.DTOs.Productivity.Tasks
{
    public class TaskDtoValidatorTests
    {
        ...
        public TaskDtoValidatorTests()
        {
            _validator = new TaskDtoValidator(); // Initialize the validator
        }

        // Test cases for Id
        [Theory]
        [InlineData("00000000-0000-0000-0000-000000000000", "Id is required.")] // Empty GUID
        public void Should_Have_Error_When_Id_Is_Invalid(Guid id, string expectedErrorMessage)
        {
            // Arrange
            var dto = new TaskDto
            {
