...
namespace FSTD.Application.Tests.DTOs.Accounts.Users
{
    public class ResetForgetPasswordDtoValidatorTests
    {
        private readonly ResetForgetPasswordDtoValidator _validator;

        public ResetForgetPasswordDtoValidatorTests()
        {
            _validator = new ResetForgetPasswordDtoValidator(); // Initialize the validator
        }
        ...
        {
            // Arrange
            var dto = new ResetForgetPasswordDto
            {
                Email = email,
                Token = "ValidToken",
        ...
        [InlineData("short", "Password must be at least 10 characters long.")] // Assuming IsPassword validator handles strength validation
