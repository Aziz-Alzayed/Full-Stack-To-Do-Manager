...
namespace FSTD.API.Controllers.Accounts
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [AllowAnonymous]
        [HttpPut("ForgatePassword")]
        public async Task<IActionResult> ForgatePassword([FromBody] ForgetPasswordDto request)
        {
        ...
        [AllowAnonymous]
        [HttpPut("ResetForgatePassword")]
        public async Task<IActionResult> ResetForgatePassword([FromBody] ResetForgetPasswordDto request)
        {
